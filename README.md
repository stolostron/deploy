...
You have multiple choices of installation:
  ...
  - [downstream images v2.0+](https://github.com/pen-cluster-management/deploy/tree/master#deploying-downstream-builds-snapshots-for-product-quality-engineering-only-20) - instructions to deploy downstream images, i.e. for QE
